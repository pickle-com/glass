            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <p className="text-gray-600 mb-4">New to pickleglass? Learn about basic features and setup methods.</p>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <p className="text-gray-600 mb-4">Check out frequently asked questions and answers from other users.</p>
                        <div className="space-y-3">
                            <details className="text-sm">
                                <summary className="font-medium text-gray-700 cursor-pointer">How do I change the context?</summary>
                            ...
                            <details className="text-sm">
                                <summary className="font-medium text-gray-700 cursor-pointer">Where can I check my activity history?</summary>
                                <p className="text-gray-600 mt-2 pl-4">You can check your past activity records on the My Activity page.</p>
                            </details>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">Join Community →</button>
                    </div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <p className="text-gray-600 mb-4">Couldn't find a solution? Contact us directly.</p>
                        <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">Contact via Email →</button>
                    </div>
                </div>
