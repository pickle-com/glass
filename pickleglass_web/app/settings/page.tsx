        ...
        <div className="space-y-8">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                        billingCycle === 'monthly' ? 'bg-gray-200 text-gray-900' : 'text-gray-600 hover:text-gray-900'
                    }`}
                >
                    Monthly
                </button>
                <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                        billingCycle === 'annually' ? 'bg-gray-200 text-gray-900' : 'text-gray-600 hover:text-gray-900'
                    }`}
                >
                    Annually
                </button>
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-6">Experience how Pickle Glass works with unlimited responses.</p>
                    ...
                    <button className="w-full py-2 px-4 bg-gray-200 text-gray-700 rounded-md font-medium">Current Plan</button>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 opacity-60">
                    ...
                    <p className="text-gray-600 mb-6">Use latest models, get full response output, and work with custom prompts.</p>
                    ...
                    <button className="w-full py-2 px-4 bg-cyan-400 text-white rounded-md font-medium">Coming Soon</button>
                </div>
                ...
                <div className="bg-gray-800 text-white rounded-lg p-6 opacity-60">
                    ...
                    <p className="text-gray-300 mb-6">Specially crafted for teams that need complete customization.</p>
                    ...
                    <button className="w-full py-2 px-4 bg-gray-600 text-white rounded-md font-medium">Coming Soon</button>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        <div className={`p-4 rounded-lg border ${isFirebaseMode ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}>
                            <div className="flex items-center justify-between">
                                ...
                                {isFirebaseMode && (
                                    <button onClick={handleLogout} className="px-3 py-1 text-sm text-blue-600 hover:text-blue-700 underline">
                                        Logout
                                    </button>
                                )}
                            </div>
